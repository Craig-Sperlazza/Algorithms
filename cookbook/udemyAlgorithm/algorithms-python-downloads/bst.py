...
class BinarySearchTree(object):
	...
	def removeNode(self, data, node):
		...
		if data < node.data:
			...
			#predecessor is the largest item in the left subtree
			#sucessor is the smallest item in the right subtree
			#can swap with either technically but here we do predecssor (bottom right of left subtree)
	...
	def remove(self, data):
		if self.root:
			...
			#I added this below because his code was confusing if anything breaks switch back
